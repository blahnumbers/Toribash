...
local function atmo_heave_enterframe(_, speed)
	...
	for i=0,200 do
		heaven_cloud_rad[i] = heaven_cloud_rad[i] + heaven_cloud_delta[i] * speed
		heaven_cloud_alpha[i] = heaven_cloud_alpha[i] + heaven_cloud_delta[i] * speed
...
return {
	onRender = atmo_heaven,
	onEnterFrame = atmo_heave_enterframe
}