...
local function atmo_night_club_red()
	set_color(0.50,0.10,0.10,1)
	...
	set_color(0.40,0.00,0.00,1)
	draw_box(32.5, 25, 2, 15, 30, 4, 0, 0, 0)
	
	set_color(1.00,1.00,0.00,0.1)
	draw_box(32.5, 25, 8, 15, 30, 8, 0, 0, 0)
	
	set_color(0.30,0.30,0.00,1)
	draw_box(-32.5, -25, 2, 15, 30, 4, 0, 0, 0)
	draw_box(-32.5, -25, 9.5, 15, 30, 1, 0, 0, 0)
	
	for i=0,5 do
		if(math.floor(pulse/20) % 8 == i) then
			set_color(2.00,1.00,0.00,0.9)
		else
			set_color(2.00,0.00,0.00,0.9)			
		end
...
local function atmo_night_club_enterframe(_, speed)
	...
	if(change_light==0) then
		set_shader_option(4, 4 * math.random(0, 100) / 200, math.random(0, 100) / 200, math.random(0, 100) / 200, 1)
	end
	if(change_floor==0) then
		set_shader_option(2, 4 * math.random(0, 100) / 200, math.random(0, 100) / 200, math.random(0, 100) / 200, 1)
	end
	pulse = math.round(speed)
end

return {
	onRender = atmo_night_club_red,
