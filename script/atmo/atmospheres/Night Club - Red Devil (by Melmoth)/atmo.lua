...
local function atmo_night_club_red()
	...
	if(is_animated()) then
		...
		if(change_light==0) then
			run_cmd("worldshader 4 " .. 4*math.random(0,100)/200 .. " " .. math.random(0,100)/200 .. " " .. math.random(0,100)/200)
		end
		if(change_floor==0) then
			run_cmd("worldshader 2 " .. 4*math.random(0,100)/200 .. " " .. math.random(0,100)/200 .. " " .. math.random(0,100)/200)
		end
		pulse = pulse + 1
	end
end

add_hook("draw3d", "atmo", atmo_night_club_red)