				...
				for i=1,11 do
					if flystar_anim[i] == 0 then
						if flystar_bigstep[i] == 0 then
							...
							flystar_bigstep[i] = flystar_bigstep[i] - 1
						end
					else
						--animation in progress
						flystar_step[i] = flystar_step[i] + 1
												
						flystar__pos_X[i] = flystar__pos_X[i] + flystar_dir_X[i]
						flystar__pos_Y[i] = flystar__pos_Y[i] + flystar_dir_Y[i]
						flystar__pos_Z[i] = flystar__pos_Z[i] + flystar_dir_Z[i]
						
						if flystar_step[i] <= flystar_bigstep[i] then
							flystar_alpha[i] = flystar_alpha[i] - (flystar_alpha[i]/flystar_bigstep[i])*flystar_step[i]
						else
							flystar_anim[i] = 0
							flystar_step[i] = 0
...
add_hook("draw3d", "atmo", atmo_outer_space)