...
local function atmo_tradi_dojo()
	set_color(0.76,0.69,0.41,1)
	...
	if(get_option("shaders")==0) then
		...
		set_color(0.95, 0.80, 0.30,1)
		draw_box(0, 0, 0.02, 80, 80, 0.001, 0, 0, 0)
	end
	set_color(0.3,0.00,0.00,1)
...
add_hook("draw3d", "atmo", atmo_tradi_dojo)