		...
		if string.match(ln, "^PRODUCT") then
			...
			elseif (data_stream[2] == "78") then 
				if (string.lower(data_stream[5]) == "colossal sword" or
					...
					string.lower(data_stream[5]) == "demon wings") then
					data_stream[2] = "23"
				else
					data_stream[2] = "22"
				end
...
function set_player_color(item)
	...
	elseif (name == "Head Models" or name == "Misc Models" or name == "Sale items") then
		...
		elseif (model_name == "candy_cane" or
			...
			model_name == "fish_friend") then run_cmd("obj load data/script/torishop/models/"..model_name..".obj 0 1 0 255 1 0 0 0")
...
function mouse_up(mouse_btn, x, y)
	...
	if (main_page == true) then
		...
		if (height >= 720) then
			if (main_view == 0) then
				gotofeatured(buttons.sfeatured, nil, nil, nil, x, y, "http://forum.toribash.com/tori_token_exchange.php")
			elseif (main_view == 1) then
				gotofeatured(buttons.sfeatured, 3, 21, 20, x, y, nil)
			else
				gotofeatured(buttons.sfeatured, nil, nil, nil, x, y, "http://forum.toribash.com/tori_token_exchange.php")
			end
		end
...
function load_images()
	...
	torishop_announcement2 = load_texture("/torishop/gui/featureddealwithit.tga")
	torishop_announcement3 = load_texture("/torishop/gui/featuredfulltextures.tga")
	torishop_announcement4 = load_texture("/torishop/gui/featuredtorininja.tga")
