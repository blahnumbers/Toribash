...
local finalPos = { x = 11, y = 17, z = 0, rad = 2, complete = tbTutorialsTaskMark and tbTutorialsTaskMark:isDisplayed() }
--local trigObjectId = 32
local checkPoints = {
	{ x = 5.5, y = 22.25, z = 36, h = 5, w = 5, zh = 8, rad = 4, task = 1, complete = tbTutorialsTask.optional[1] and tbTutorialsTask.optional[1].complete },
	{ x = -19, y = 13, z = 36, h = 5, w = 5, zh = 8, rad = 6, task = 2, complete = tbTutorialsTask.optional[2] and tbTutorialsTask.optional[2].complete },
	{ x = -35, y = 24.4, z = 36, h = 5, w = 5, zh = 8, rad = 5, task = 3, complete = tbTutorialsTask.optional[3] and tbTutorialsTask.optional[3].complete },
	{ x = -23.5, y = -12, z = 36, h = 5, w = 5, zh = 8, rad = 4, task = 4, complete = tbTutorialsTask.optional[4] and tbTutorialsTask.optional[4].complete },
}
...
local function showUploadWindow(viewElement, reqTable)
	...
	local function uploadReplay(name)
		...
		if (Request.queue ~= nil) then
			Request:queue(function()
				upload_event_replay(name, "Event Squad's Flash Course 3 event entry", "ESEVNT" .. CURRENT_TUTORIAL, "replay/my replays/" .. name .. ".rpl")
