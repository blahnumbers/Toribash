	...
	CHECKPOINTS = {
		{
			...
			shape = CAPSULE,
			pos = { x = 1, y = -21.5, z = 0 },
			size = { x = 2.5, y = 100000, z = 0 },
			color = get_color_rgba(COLORS.VAMPIRE),
			effects = {
				id = EFFECT_TYPE.FRESNEL,
				glowColor = COLORS.PURE,
				glowIntensity = 5
			},
			ignoreDepth = true,
		...
		},
		{
			...
			task = 2,
			shape = CUBE,
			pos = { x = -4.5, y = -11, z = 1.5 },
			size = { x = 3.4, y = 3.4, z = 3.9 },
			color = get_color_rgba(COLORS.AQUA),
			effects = {
				id = EFFECT_TYPE.FRESNEL,
				glowColor = COLORS.PURE,
				glowIntensity = 5
		...
		},
		{
			...
			task = 1,
			shape = CUBE,
			pos = { x = -2.25, y = -11.85, z = 5.2 },
			size = { x = 8.75, y = 3, z = 3.2 },
			color = get_color_rgba(COLORS.ORC),
			effects = {
				id = EFFECT_TYPE.FRESNEL,
				glowColor = COLORS.PURE,
				glowIntensity = 5
