...
local finalPos = { x = 0, y = -29, z = 1.9, rad = 3, complete = tbTutorialsTaskMark and tbTutorialsTaskMark:isDisplayed(), visible = false }
--local trigObjectId = 32
local checkPoints = {
	{ x = -4, y = 16.9, z = 51.28, h = 5, w = 5, zh = 6, shape = CUBE, rad = 2.3, color = { 1, 0, 0, 0.5 }, task = 1, complete = tbTutorialsTask.optional[1] and tbTutorialsTask.optional[1].complete, costModifier = 1 },
	{ x = 4, y = 11.9, z = 9.33, h = 5, w = 5, zh = 6, shape = CUBE, rad = 2.3, color = { 0, 0, 1, 0.5 }, task = 2, complete = tbTutorialsTask.optional[2] and tbTutorialsTask.optional[2].complete, costModifier = 0 },
}
...
local function setDiscordRPC()
	...
	set_discord_rpc("Leggang " .. tutorialNum, TB_MENU_LOCALIZED.DISCORDRPCPLAYINGSPEVENT or "Playing SP Event")
end
