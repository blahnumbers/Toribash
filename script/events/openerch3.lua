...
local function setModSettings()
	...
	start_new_game()
	UIElement:runCmd("set matchframes 800")
	UIElement:runCmd("set engagedistance 174")
	UIElement:runCmd("set fracture 0")
	UIElement:runCmd("set gravity 0 0 -19")
