...
if (TBMenu == nil) then
	...
	---
	---**Version 5.76**
	---* Minor visual tweaks to generic moveable windows
	---
	---**Version 5.74
...
function TBMenu:showToolsSection()
	...
	local tbMenuToolsButtonsData = {
		...
		{ title = TB_MENU_LOCALIZED.MAINMENUMODMAKERNAME, subtitle = TB_MENU_LOCALIZED.MAINMENUMODMAKERDESC, size = 0.25, vsize = 0.5, ratio = 1.055, image = "../textures/menu/modmaker2.tga", ratio2 = 0.5, image2 = "../textures/menu/modmaker3.tga", action = function() dofile("system/modmaker.lua") end, quit = true, disableUnload = true },
...
function TBMenu:spawnMoveableWindow(rect, globalid)
	...
	windowMover:addCustomDisplay(true, function()
		...
		draw_quad(posX, windowMover.pos.y + 12, 30, 2)
		draw_quad(posX, windowMover.pos.y + 21, 30, 2)
	end)
	windowMover:addMouseHandlers(function(_, x, y)
				disable_mouse_camera_movement()
			...
			if (windowMover.hoverState == BTN_DN) then
				x = x - windowMover.pressedPos.x
				y = y - windowMover.pressedPos.y
	...
	TBMenu:spawnCloseButton(windowMoverHolder, {
		x = -windowMoverHolder.size.h, y = 0,
		w = windowMoverHolder.size.h, h = windowMoverHolder.size.h
	}, function()
